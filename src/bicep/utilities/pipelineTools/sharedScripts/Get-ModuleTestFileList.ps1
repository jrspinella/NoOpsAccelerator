...
.EXAMPLE
Get-ModuleTestFileList -ModulePath 'C:\src\bicep\platforms\hub1spoke'
Returns the relative file paths of all test files of the virtual machines module in the default test folder ('tests').
.EXAMPLE
Get-ModuleTestFileList -ModulePath 'C:\src\bicep\platforms\hub1spoke' -SearchFolder 'parameters'
