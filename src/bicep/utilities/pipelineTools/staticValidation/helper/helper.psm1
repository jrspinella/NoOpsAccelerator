...
. (Join-Path $repoRootPath 'utilities' 'pipelineTools' 'sharedScripts' 'Get-NestedResourceList.ps1')
. (Join-Path $repoRootPath 'utilities' 'pipelineTools' 'sharedScripts' 'Get-ScopeOfTemplateFile.ps1')
. (Join-Path $repoRootPath 'utilities' 'pipelineTools' 'sharedScripts' 'Get-ModuleTestFileList.ps1')
