...
module modLogAnalyticsWorkspace '../../overlays/hub-spoke-core/vdms/logging/anoa.lz.logging.bicep' = {
...
module modIdentityNetwork '../../overlays/hub-spoke-core/vdss/identity/anoa.lz.id.network.bicep' = {
...
module modSharedServicesNetwork '../../overlays/hub-spoke-core/vdms/sharedservices/anoa.lz.svcs.network.bicep' = {
...
module modDataSharedServicesNetwork '../../overlays/hub-spoke-core/vdms/dataSharedServices/anoa.lz.data.svcs.network.bicep' = {
  name: 'deploy-spoke-svcs-${parLocation}-${parDeploymentNameSuffix}'
...
module modSpokeIdToHubVirtualNetworkPeerings '../../overlays/hub-spoke-core/peering/spoke/anoa.lz.spoke.network.peering.bicep' = if (parIdentitySpoke.peerToHubVirtualNetwork) {
...
module modSpokeSharedServicesToHubVirtualNetworkPeerings '../../overlays/hub-spoke-core/peering/spoke/anoa.lz.spoke.network.peering.bicep' = if (parSharedServicesSpoke.peerToHubVirtualNetwork) {
...
module modSpokeDataSharedServicesToHubVirtualNetworkPeerings '../../overlays/hub-spoke-core/peering/spoke/anoa.lz.spoke.network.peering.bicep' = if (parDataSharedServicesSpoke.peerToHubVirtualNetwork) {
  name: 'deploy-vnet-spoke-peerings-svcs-${parLocation}-${parDeploymentNameSuffix}'
