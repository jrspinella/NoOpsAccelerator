...
var privateDnsZones_privatelink_aks_name = ( environment().name =~ 'AzureCloud' ? 'privatelink.${vnetLocation}.azmk8s.io' : 'privatelink.${vnetLocation}.azmk8s.io' )
...
resource privatelink_aks_azure_com 'Microsoft.Network/privateDnsZones@2018-09-01' = {
  name: privateDnsZones_privatelink_aks_name
  location: 'global'
  tags: tags
}
...
resource privateDnsZones_privatelink_aks_privateDnsZones_privatelink_aks_link 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2018-09-01' = {
  name: '${privateDnsZones_privatelink_aks_name}/${privateDnsZones_privatelink_aks_name}-link'
  location: 'global'
  properties: {
    registrationEnabled: false
    virtualNetwork: {
...
output aksPrivateDnsZoneId string = privatelink_aks_azure_com.id
