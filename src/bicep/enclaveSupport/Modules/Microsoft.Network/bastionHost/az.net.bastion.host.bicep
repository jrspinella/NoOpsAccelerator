...
module publicIPAddress '../publicIPAddress/az.net.public.ip.address.bicep' = if (empty(azureBastionSubnetPublicIpId) && isCreateDefaultPublicIP) {
...
module azureBastion_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
