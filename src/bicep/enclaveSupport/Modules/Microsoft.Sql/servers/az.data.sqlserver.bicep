...
module server_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
...
module server_databases './databases/az.data.sqlserver.database.bicep' = [for (database, index) in databases: {
...
module server_firewallRules './firewallRules/az.data.sqlserver.firewall.rule.bicep' = [for (firewallRule, index) in firewallRules: {
...
module server_securityAlertPolicies './securityAlertPolicies/az.data.sqlserver.security.alert.policy.bicep' = [for (securityAlertPolicy, index) in securityAlertPolicies: {
...
module server_vulnerabilityAssessment './vulnerabilityAssessments/az.data.sqlserver.vulnerability.assessment.bicep' = if (!empty(vulnerabilityAssessmentsObj)) {
