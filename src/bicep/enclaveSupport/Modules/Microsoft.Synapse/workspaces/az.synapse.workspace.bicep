...
module workspace_cmk_rbac './rbac/cmkRbac.bicep' = if (encryptionActivateWorkspace) {
...
module workspace_key './keys/az.synapse.workspace.key.bicep' = if (encryptionActivateWorkspace) {
...
// RBAC
module workspace_rbac './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
...
// Endpoints
module workspace_privateEndpoints '../../Microsoft.Network/privateEndPoints/az.net.private.endpoint.bicep' = [for (privateEndpoint, index) in privateEndpoints: {
