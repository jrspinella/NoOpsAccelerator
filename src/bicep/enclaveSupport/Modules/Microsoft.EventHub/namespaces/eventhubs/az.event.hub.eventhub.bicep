...
module eventHub_consumergroups './consumergroups/az.event.hub.eventhub.consumer.group.bicep' = [for (consumerGroup, index) in consumerGroups: {
...
module eventHub_authorizationRules './authorizationRules/az.event.hub.eventhub.authorization.rule.bicep' = [for (authorizationRule, index) in authorizationRules: {
...
module eventHub_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
