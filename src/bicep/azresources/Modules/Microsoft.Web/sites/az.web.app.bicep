...
module app_appsettings './config-appsettings/az.web.app.settings.bicep' = if (!empty(appSettingsKeyValuePairs)) {
...
module app_authsettingsv2 './config-authsettingsv2/az.web.app.auth.settings.bicep' = if (!empty(authSettingV2Configuration)) {
...
module app_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
