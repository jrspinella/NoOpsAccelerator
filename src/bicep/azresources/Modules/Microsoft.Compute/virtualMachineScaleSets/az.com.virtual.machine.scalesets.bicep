...
module vmss_domainJoinExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionDomainJoinConfig.enabled) {
...
module vmss_microsoftAntiMalwareExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionAntiMalwareConfig.enabled) {
...
module vmss_microsoftMonitoringAgentExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionMonitoringAgentConfig.enabled) {
...
module vmss_dependencyAgentExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionDependencyAgentConfig.enabled) {
...
module vmss_networkWatcherAgentExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionNetworkWatcherAgentConfig.enabled) {
...
module vmss_desiredStateConfigurationExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionDSCConfig.enabled) {
...
module vmss_customScriptExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionCustomScriptConfig.enabled) {
...
module vmss_diskEncryptionExtension 'extensions/az.com.virtual.machine.scalesets.extension.bicep' = if (extensionDiskEncryptionConfig.enabled) {
...
module vmss_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
