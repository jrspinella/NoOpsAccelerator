...
module appGroup_applications 'applications/az.desktop.virtualization.apps.bicep' = [for (application, index) in applications: {
...
module appGroup_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
