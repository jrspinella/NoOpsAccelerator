...
module vpnGateway_natRules './natRules/az.net.vpn.gateway.nat.rule.bicep' = [for (natRule, index) in natRules: {
...
module vpnGateway_connections './connections/az.net.vpn.gateway.connection.bicep' = [for (connection, index) in connections: {
