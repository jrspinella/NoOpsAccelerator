...
module virtualHub_routeTables './hubRouteTables/az.net.virutal.hub.route.table.bicep' = [for (routeTable, index) in hubRouteTables: {
...
module virtualHub_hubVirtualNetworkConnections './hubVirtualNetworkConnections/az.net.virutal.hub.vNet.connection.bicep' = [for (virtualNetworkConnection, index) in hubVirtualNetworkConnections: {
