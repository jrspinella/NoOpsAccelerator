...
module virtualNetwork_subnets './subnets/az.net.subnet.bicep' = [for (subnet, index) in subnets: {
...
module virtualNetwork_peering_local './virtualNetworkPeering/az.net.virtual.network.peering.bicep' = [for (peering, index) in virtualNetworkPeerings: {
...
module virtualNetwork_peering_remote './virtualNetworkPeering/az.net.virtual.network.peering.bicep' = [for (peering, index) in virtualNetworkPeerings: if (contains(peering, 'remotePeeringEnabled') ? peering.remotePeeringEnabled == true : false) {
...
module virtualNetwork_roleAssignments './rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
