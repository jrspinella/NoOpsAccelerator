...
module database_backupShortTermRetentionPolicy 'backupShortTermRetentionPolicies/az.data.managed.instance.database.backup.shortTerm.retention.policy.bicep' = if (!empty(backupShortTermRetentionPoliciesObj)) {
...
module database_backupLongTermRetentionPolicy 'backupLongTermRetentionPolicies/az.data.managed.instance.database.backup.longTerm.retention.policy.bicep' = if (!empty(backupLongTermRetentionPoliciesObj)) {
