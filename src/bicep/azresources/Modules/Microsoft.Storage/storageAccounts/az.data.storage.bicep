...
module storageAccount_roleAssignments 'rbac/roleAssignments.bicep' = [for (roleAssignment, index) in roleAssignments: {
...
// Containers
module storageAccount_blobServices './blobServices/az.data.storage.blob.service.bicep' = if (!empty(blobServices)) {
...
// File Shares
module storageAccount_fileServices './fileServices/az.data.storage.file.service.bicep' = if (!empty(fileServices)) {
...
// Queue
module storageAccount_queueServices './queueServices/az.data.storage.queue.service.bicep' = if (!empty(queueServices)) {
...
// Table
module storageAccount_tableServices './tableServices/az.data.storage.table.service.bicep' = if (!empty(tableServices)) {
