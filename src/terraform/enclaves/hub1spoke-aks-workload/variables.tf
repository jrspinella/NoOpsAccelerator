...
variable "root_management_group_id" {
  description = "The root management group is used to specify where to set the root for all Landing Zone deployments. Usually the Tenant ID when deploying the Mission Enclave."
  type        = string
  default     = "anoa"
...
variable "management_groups" {
  ...
  default = [{
    ...
    parent_management_group_id = "<<tenantId>>"
